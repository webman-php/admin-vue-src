    ...
    >
      <div v-show="activeKey === 'fieldTab'">
        ...
        <div class="ant-row pb-2 b">
          <div class="ant-col-4 pl-2 align-center"> 字段</div><div class="ant-col-4"> 备注</div><div class="ant-col-3 pl-2">长度/值</div><div class="ant-col-4 pl-2">默认值</div><div class="ant-col-4 pl-2">类型</div><div class="ant-col-1">主键</div><div class="ant-col-1">自增</div><div class="ant-col-1">允许空</div><div class="ant-col-2 pl-2">操作</div>
        </div>
      ...
      <div v-show="activeKey === 'formTab'">
        <div class="ant-row pb-2 b">
          <div class="ant-col-4 pl-2"><br>字段</div><div class="ant-col-4"><br>备注</div><div class="ant-col-4 pl-2"><br>控件类型</div><div class="ant-col-1 pl-2">表单<br>显示</div><div class="ant-col-1 pl-2">列表<br>显示</div><div class="ant-col-1">支持<br>排序</div><div class="ant-col-1">是否<br>只读</div><div class="ant-col-1">是否<br>查询</div><div class="ant-col-2 pl-2"><br>查询类型</div><div class="ant-col-4 pl-2"><br>控件参数</div>
        </div>
        <BasicForm
          ref="formElRef"
          :labelWidth="10"
      ...
      <div v-show="activeKey === 'keyTab'">
        <div class="ant-row pb-2 b">
          <div class="ant-col-6 pl-2"><br>索引名称</div><div class="ant-col-6"><br>索引字段</div><div class="ant-col-6 pl-2"><br>索引类型</div>
        </div>
        <BasicForm
          ref="keyElRef"
          :labelWidth="10"
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    const [register, {closeModal}] = useModalInner(async (data: any) => {
      ...
      const tableInfo = tableName ? await apiGet(TableApi.SCHEMA, {table: tableName}) : {table:{}};
      tableSchemas = [];
    ...
    function getFormColumns()
    {
      ...
      for (let i in fieldsValue.field) {
        ...
        formEl.appendSchemaByField({
          ...
          defaultValue: primary ? false : formSchemas[field]?.form_show,
        }, '');
        formEl.appendSchemaByField({
          field : `list_show[${i}]`,
          component: 'Checkbox',
          ...
          defaultValue: formSchemas[field]?.list_show
        }, '');
        formEl.appendSchemaByField({
          field : `enable_sort[${i}]`,
          component: 'Checkbox',
    ...
    async function addKey() {
      ...
      for (let index in defaultKeySchemas) {
        ...
        schema.field = schema.field === '0' ? String(keyNum.value) : `${schema.field}[${keyNum.value}]`;
        keyEl.appendSchemaByField(
          schema,
          '',
        );
      }
