...
const selectUrl = '/app/admin/auth/admin/select';
const insertUrl = '/app/admin/auth/admin/insert';
const updateUrl = '/app/admin/auth/admin/update';
const deleteUrl = '/app/admin/auth/admin/delete';
const schemaUrl = '/app/admin/auth/admin/schema';
